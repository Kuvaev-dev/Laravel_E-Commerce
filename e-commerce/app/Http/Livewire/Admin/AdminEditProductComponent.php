...
class AdminEditProductComponent extends Component
{
    ...
    public function mount($product_slug) {
        ...
        $this->inputs = $product->attributeValues->where('product_id', $product->id)
                                                ->unique('product_attribute_id')
                                                ->pluck('product_attribute_id');
        $this->attribute_arr = $product->attributeValues->where('product_id', $product->id)
                                                        ->unique('product_attribute_id')
                                                        ->pluck('product_attribute_id');
    ...
    public function updateProduct() {
        ...
        foreach ($this->attribute_values as $key=>$attribute_value) {
            ...
            foreach ($avalues as $avalue) {
                ...
                $attr_value->product_attribute_value = $key;
