                        ...
                        @foreach($pattributes as $pattribute)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="#" onclick="confirm('Are you sure, you want delete this category?') || event.stopImmediatePropagation()" wire:click.prevent="deleteAttribute({{ $pattribute->id }})" style="margin-left: 10px"><i class="fa fa-times fa-2x text-danger"></i></a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
